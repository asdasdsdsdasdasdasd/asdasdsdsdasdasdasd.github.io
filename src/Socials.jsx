...
const ITEMS = [
  ...
  {
    id: "email", label: "EMAIL", handle: "chiwaiwan21@gmail.com", href: "mailto:chiwaiwan21@gmail.com", icon: "✉️", barIcon: icon2, bars: 1, newBars: [0], counts: ["contact"],
    links: ["mailto:chiwaiwan21@gmail.com"],
    stats: [
      { tag: "HK", value: "✓", color: "#e1306c" },
      { tag: "ML", value: "✓",  color: "#f77737" },
    ],
  },
  {
    id: "linkedin", label: "LINKEDIN", handle: "Wan Chi Wai", href: "https://www.linkedin.com/", icon: "🔗", barIcon: icon3, bars: 1, newBars: [0], counts: ["profile"],
    links: ["linkedin.com/in/"],
    stats: [
      { tag: "JOB", value: "AI", color: "#00f2ea" },
      { tag: "HK", value: "✓",  color: "#ff0050" },
    ],
  },
];
